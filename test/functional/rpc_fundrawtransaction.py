...
class RawTransactionsTest(BaddcoinTestFramework):
    ...
    def test_invalid_change_address(self):
        ...
        assert_raises_rpc_error(-5, "Change address must be a valid baddcoin address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
