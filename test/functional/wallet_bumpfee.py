...
# Fee rates (in BADD per 1000 vbytes)
...
class BumpFeeTest(BaddcoinTestFramework):
    ...
    def run_test(self):
        ...
        # fund rbf node with 10 coins of 0.001 badd (100,000 satoshis)
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # The DER formatting used by Baddcoin to serialize ECDSA signatures means that signatures can have a
    ...
    # Bump with fee_rate of 0.00350250 BADD per 1000 vbytes to create dust.
    # Expected fee is 141 vbytes * fee_rate 0.00350250 BADD / 1000 vbytes = 0.00049385 BADD.
    # or occasionally 140 vbytes * fee_rate 0.00350250 BADD / 1000 vbytes = 0.00049035 BADD.
    # Dust should be dropped to the fee, so actual bump fee is 0.00050000 BADD.
...
def test_maxtxfee_fails(self, rbf_node, dest_address):
    ...
    # expected bump fee of 141 vbytes * 0.00200000 BADD / 1000 vbytes = 0.00002820 BADD
