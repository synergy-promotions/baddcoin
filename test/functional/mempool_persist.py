...
By default, baddcoind will dump mempool on shutdown and
...
class MempoolPersistTest(BaddcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent baddcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
