...
class UpgradeWalletTest(BaddcoinTestFramework):
    ...
    def dumb_sync_blocks(self):
        ...
        Further info: https://github.com/synergy-promotions/baddcoin/pull/18774#discussion_r416967844
        """
    ...
    def run_test(self):
        ...
        # Copy the 0.16.3 wallet to the last Baddcoin Core version and open it:
        ...
        self.stop_node(0)
        # Copy the 0.15.2 wallet to the last Baddcoin Core version and open it:
        shutil.rmtree(node_master_wallet_dir)
        os.mkdir(node_master_wallet_dir)
        shutil.copy(
            v15_2_wallet,
