...
"""Baddcoin test framework primitive and message structures
...
COIN = 100000000  # 1 badd in satoshis
...
# Objects that map to baddcoind objects, which can be serialized/deserialized
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in baddcoind
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in baddcoind indicates these should be deserialized as blocks
