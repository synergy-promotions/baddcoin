...
class TestShell:
    """Wrapper Class for BaddcoinTestFramework.

    The TestShell class extends the BaddcoinTestFramework
    ...
    class __TestShell(BaddcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BaddcoinTestFramework child class.
            self.num_nodes = 1
