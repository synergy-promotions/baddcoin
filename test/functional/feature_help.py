...
"""Verify that starting baddcoin with -h works as expected."""

from test_framework.test_framework import BaddcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BaddcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start baddcoin with -h for help text")
        ...
        self.log.info("Start baddcoin with -version for version information")
        ...
        self.log.info("Start baddcoind with -fakearg to make sure it does not start")
