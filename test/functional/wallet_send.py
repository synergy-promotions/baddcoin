...
class WalletSendTest(BaddcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.test_send(from_wallet=w0, to_wallet=w1, amount=1, conf_target=0.1, estimate_mode="sat/b",
                       expect_error=(-4, "Fee rate (0.00000100 BADD/kB) is lower than the minimum fee rate setting (0.00001000 BADD/kB)"))

        self.test_send(from_wallet=w0, to_wallet=w1, amount=1, conf_target=0.000001, estimate_mode="BADD/KB",
                       expect_error=(-4, "Fee rate (0.00000100 BADD/kB) is lower than the minimum fee rate setting (0.00001000 BADD/kB)"))
        ...
        self.test_send(from_wallet=w0, to_wallet=w1, amount=1, change_address="not an address",
                       expect_error=(-5, "Change address must be a valid baddcoin address"))
