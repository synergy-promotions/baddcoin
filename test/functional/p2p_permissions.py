...
class P2PPermissionsTests(BaddcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].baddcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].baddcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
