...
This document provides guidelines for internationalization of the Baddcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `baddcoin_en.ts` remains unchanged.
