...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the baddcoin repository."
  exit 1
fi
...
# See https://github.com/synergy-promotions/baddcoin/issues/16064
...
echo 'When compiling baddcoind, run `./configure` in the following way:'
echo
