...
the file-order will change between invocations. The patch can be seen here: [cdrkit-deterministic.patch](https://github.com/synergytcs/baddcoin/blob/master/depends/patches/native_cdrkit/cdrkit-deterministic.patch).
