...
Arguments:
    <base_directory> - The base directory of a baddcoin source code repository.
...
Arguments:
    <file> - A source file in the baddcoin repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Baddcoin
