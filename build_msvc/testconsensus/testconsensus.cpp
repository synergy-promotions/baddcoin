...
// baddcoin includes.
#include <..\src\script\baddcoinconsensus.h>
...
int main()
{
    std::cout << "baddcoinconsensus version: " << baddcoinconsensus_version() << std::endl;
    ...
    auto op0Result = baddcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, baddcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
