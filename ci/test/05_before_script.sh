...
if [ "$TRAVIS_OS_NAME" == "osx" ]; then
  echo > $HOME/Library/Application\ Support/Baddcoin
else
  DOCKER_EXEC echo \> \$HOME/.baddcoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/synergy-promotions/baddcoin/pull/18288#discussion_r433189350 for
  # details.
