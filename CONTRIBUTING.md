Contributing to Baddcoin Core
============================

The Baddcoin Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Baddcoin Core
...
Before you start contributing, familiarize yourself with the Baddcoin Core build
system and tests. Refer to the documentation in the repository on how to build
Baddcoin Core and how to run the unit tests, functional tests, and fuzz tests.
...
[Baddcoin Core PR Review Club](https://baddcoincore.reviews/) meeting.
...
Most communication about Baddcoin Core development happens on IRC, in the
`#baddcoin-core-dev` channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/baddcoin-core-dev/](http://www.erisian.com.au/baddcoin-core-dev/)
and [http://gnusha.org/baddcoin-core-dev/](http://gnusha.org/baddcoin-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/baddcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to baddcoin-qt
...
fork of Baddcoin Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the Baddcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Baddcoin
Network Protocol consensus changes.

Whether a pull request is merged into Baddcoin Core rests with the project merge
...
Patches that change Baddcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Baddcoin consensus, it must have been
...
The project leader is the release manager for each Baddcoin Core release.
