...
#ifndef BADDCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define BADDCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@baddcoin.
 *
 ...
 *
 * The chacha20-poly1305@baddcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@baddcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@baddcoin are relatively fast in
...
#endif // BADDCOIN_CRYPTO_CHACHA_POLY_AEAD_H
