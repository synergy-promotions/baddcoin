                        ...
                        {RPCResult::Type::OBJ, "scriptPubKey", "",
                            {
                                ...
                                {RPCResult::Type::ARR, "addresses", "array of baddcoin addresses",
...
static void BIP9SoftForkDescPushBack(UniValue& softforks, const std::string &name, const Consensus::Params& consensusParams, Consensus::DeploymentPos id) EXCLUSIVE_LOCKS_REQUIRED(cs_main)
{
    ...
    //HIDE TEST DUMMY [
    if (consensusParams.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit == 28 && consensusParams.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime == 0) return;
    //]
...
UniValue dumptxoutset(const JSONRPCRequest& request)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/synergy-promotions/baddcoin/pull/15606#discussion_r274479369
        //
        LOCK(::cs_main);
