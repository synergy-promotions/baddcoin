 ...
 */
#ifndef BADDCOIN_UTIL_SYSTEM_H
#define BADDCOIN_UTIL_SYSTEM_H
...
extern const char * const BADDCOIN_CONF_FILENAME;
extern const char * const BADDCOIN_SETTINGS_FILENAME;
