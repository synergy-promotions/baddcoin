...
static constexpr int64_t STALE_CHECK_INTERVAL = 10 * 60; // 10 minutes //genesis-premine= 3600 * 24 * 365; 
...
static constexpr int STALE_RELAY_AGE_LIMIT = 30 * 24 * 60 * 60; //genesis-premine=3600 * 24 * 365;
    ...
    while (!done && !orphan_work_set.empty()) {
        ...
        if (AcceptToMemoryPool(m_mempool, orphan_state, porphanTx, &removed_txn, false /* bypass_limits */, 0 /* nAbsurdFee */)) {
            ...
            if (orphan_state.GetResult() != TxValidationResult::TX_WITNESS_STRIPPED) {
                ...
                // https://github.com/synergy-promotions/baddcoin/issues/8279 for details.
                // We can remove this restriction (and always add wtxids to
                // the filter even for witness stripped transactions) once
                // wtxid-based relay is broadly deployed.
                // See also comments in https://github.com/synergy-promotions/baddcoin/pull/18044#discussion_r443419034
