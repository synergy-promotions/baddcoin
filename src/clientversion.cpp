 ...
 * for both baddcoind and baddcoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("BADDCOIN");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/baddcoin/bips/blob/master/bip-0014.mediawiki)
 */
