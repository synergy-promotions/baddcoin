...
//! Entry point for BaddcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BaddcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BaddcoinGUI tests.
void AppTests::guiTests(BaddcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BaddcoinGUI::consoleShown, this, &AppTests::consoleTests);
