...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<BaddcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_baddcoin-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_baddcoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_baddcoin-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = BaddcoinUnits::formatWithUnit(unit, balance, false, BaddcoinUnits::SeparatorStyle::ALWAYS);
    ...
    // Amount input
    BaddcoinAmountField* amountInput = receiveCoinsDialog.findChild<BaddcoinAmountField*>("reqAmount");
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_baddcoin-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI(m_node);
