...
#ifndef BADDCOIN_QT_GUIUTIL_H
#define BADDCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Baddcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "baddcoin:" URI into recipient object, return true on successful parsing
