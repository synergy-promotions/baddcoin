    ...
    mapper(nullptr)
{
    ...
    ui->baddcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->baddcoinAtStartup);
    ...
    ui->baddcoinAtStartup->setToolTip(ui->baddcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->baddcoinAtStartup->setText(ui->baddcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openBaddcoinConfButton->setToolTip(ui->openBaddcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BaddcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->baddcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBaddcoinConfButton_clicked()
{
