    ...
    platformStyle(_platformStyle)
{
    ...
    // normal baddcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying baddcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &BaddcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
