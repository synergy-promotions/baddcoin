...
void test_one_input(const std::vector<uint8_t>& buffer)
{
    ...
    // if (result_try_no_witness) { // Uncomment when https://github.com/synergy-promotions/baddcoin/pull/17775 is merged
    if (result_try_witness) { // Remove stop-gap when https://github.com/synergy-promotions/baddcoin/pull/17775 is merged
