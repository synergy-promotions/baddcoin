...
#ifndef BADDCOIN_TEST_SCRIPTNUM10_H
#define BADDCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Baddcoin Core 0.10.0, for cross-comparison.
 */
public:
