...
static void SetupBaddcoinTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " baddcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  baddcoin-tx [options] <hex-tx> [commands]  Update hex-encoded baddcoin transaction\n" +
            "or:     baddcoin-tx [options] -create [commands]   Create hex-encoded baddcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded baddcoin transaction
