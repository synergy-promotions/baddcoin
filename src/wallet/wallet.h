...
#ifndef BADDCOIN_WALLET_WALLET_H
#define BADDCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this baddcoin node, and set to 0 for transactions that were created
...
#endif // BADDCOIN_WALLET_WALLET_H
