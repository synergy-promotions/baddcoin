...
#ifndef BADDCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define BADDCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Baddcoin Core wallet was originally a collection of unrelated private
...
#endif // BADDCOIN_WALLET_SCRIPTPUBKEYMAN_H
