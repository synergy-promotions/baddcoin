...
CWalletTx* CWallet::AddToWallet(CTransactionRef tx, const CWalletTx::Confirmation& confirm, const UpdateWalletTxFn& update_wtx, bool fFlushOnClose)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/synergytcs/baddcoin/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/synergytcs/baddcoin/pull/13339#issuecomment-461288094
...
void CWallet::transactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason) {
    ...
    if (reason == MemPoolRemovalReason::CONFLICT) {
        ...
        //    https://github.com/synergytcs/baddcoin/pull/18600#discussion_r420195993.
        ...
        //    https://github.com/synergytcs/baddcoin/pull/9371 and the prior sync
    ...
    while (!fAbortRescan && !chain().shutdownRequested()) {
        ...
        if (chain().findBlock(block_hash, FoundBlock().data(block)) && !block.IsNull()) {
            ...
            if (reorg) {
                ...
                // https://github.com/synergytcs/baddcoin/pull/14711#issuecomment-458342518
 ...
 * https://github.com/synergytcs/baddcoin/pull/1393.
 */
